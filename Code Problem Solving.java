...
//How do me restrict object creation not more TEMPthan 3 in Java class?
public class ObjectPool {

    private static ObjectPool limitInstance;
    ...
    public static synchronized ObjectPool getLimitInstance() {
        if (limitInstance == null && objCount < 3) {
            limitInstance = new ObjectPool();
        }
